    ...
    <div className="relative mt-20 grid grid-cols-3 mb-20 pb-20">
      ...
      max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
        <div className="relative w-9/12 bg-opacity-50 pointer-events-none aspect-[1635/1831]">
            <AspectRatio ratio={1635 / 1831} className="pointer-events-none relative z-50 aspect-[1635/1831] w-full">
                <NextImage fill alt="Shirt image" src="/shirt-test.png" className="pointer-events-none z-50 select-none" />
            </AspectRatio>
            ...
            <div className={cn("absolute inset-0 left-[3px] top-px r-[3px] bottom-px rounded-[32px]", `bg-blue-950`)} />
        </div>
        </div>
    </div>
  );
